...
{
    public class CreateAssetPartsMaintenaceMasterCommand : IRequest<AssetPartsMaintenaceMasterResponse>
    {
        ...
        public CreateAssetPartsMaintenaceMasterCommand()
        {

        }
    }
    public class CreateAssetEquipmentMaintenaceMasterCommand : IRequest<AssetEquipmentMaintenaceMasterResponse>
    {
        ...
        public CreateAssetEquipmentMaintenaceMasterCommand()
        {
