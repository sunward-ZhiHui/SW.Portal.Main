...
{
    public class EditFmGlobalCommand : IRequest<FmglobalResponse>
    {
    ...
    public class EditFmGlobalLineCommand : IRequest<FmglobalLineResponse>
    {
    ...
    public class EditFmGlobalLineItemCommand : IRequest<FmglobalLineItemResponse>
    {
