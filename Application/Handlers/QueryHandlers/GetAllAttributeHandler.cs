...
namespace Application.Handlers.QueryHandlers
{
    ...
    public class GetAllAttributeNameListHandler : IRequestHandler<GetAllAttributeNameList, AttributeHeaderListModel>
    {
        ...
        {
            return await _attrubutequeryRepository.GetAllAttributeNameAsync(request.DynamicForm, request.UserId,request.IsSubFormLoad);
        }
    }
    ...
    public class GetDynamicFormApiHandler : IRequestHandler<GetDynamicFormApi, List<DynamicFormData>>
    {
        ...
        {
            return (List<DynamicFormData>)await _attrubutequeryRepository.GetAllDynamicFormApiAsync(request.DynamicFormSessionId,request.DynamicFormDataSessionId,request.DynamicFormDataGridSessionId,request.DynamicFormSectionGridAttributeSessionId, request.BaseUrl);
        }
    }
