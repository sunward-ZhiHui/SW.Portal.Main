...
namespace Core.EntityModels
{
    ...
    {
        public string? Month { get; set; }
        public decimal? AddhocCust { get; set; }
        public decimal? AdHoc { get; set; }
        public decimal? ProjInv { get; set; }
        public decimal? ProdProj { get; set; }
        public decimal? ProjHS { get; set; }
        public string? ProductionTicket { get; set; }
    }
    ...
    public class StockBalance
    {
        ...
        public decimal? Antah { get; set; }
        public decimal? MSS { get; set; }
        public decimal? PX { get; set; }
        public decimal? SWSIN { get; set; }
        public decimal? SWMY { get; set; }
        public decimal? OtherStore { get; set; }
