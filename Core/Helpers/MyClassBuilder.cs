...
namespace Core.Helpers
{
    public class MyClassBuilder
    {
        ...
        private void CreateProperty(TypeBuilder typeBuilder, string propertyName, Type propertyType)
        {
            ...
            /* RequiredAttribute requiredAttribute = fieldBuilder.GetCustomAttribute<RequiredAttribute>();
             if (requiredAttribute != null)
             {
                 requiredAttribute.ErrorMessage = "Required";
             }
             RequiredAttribute requiredAttributes = new RequiredAttribute();
             requiredAttributes.ErrorMessage = "Requiredd";*/
