...
namespace Core.Repositories.Query
{
    public interface ISalesOrderService : IQueryRepository<PostSalesOrder>
    {
        ...
        Task<List<Navcustomer>> NavcustomerAsync(string company, long companyid, List<Navcustomer> navvendors);
        Task<List<SoCustomer>> NavSoCustomerAsync(string company, long companyid, List<SoCustomer> navvendors);
        ...
        Task<List<NavpostedShipment>> GetSalesDeliverOrder(ViewPlants company, NavpostedShipment navpostedShipment, List<Navcustomer> customers, List<NavpostedShipment> navpostedShipments);
    }
}
