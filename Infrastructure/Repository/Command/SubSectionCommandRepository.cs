...
{
    public class SubSectionCommandRepository : CommandRepository<SubSection>, ISubSectionCommandRepository
    {
        public SubSectionCommandRepository(IConfiguration configuration)
            : base(configuration)
        {
