    ...
    public class DynamicFormQueryRepository : QueryRepository<DynamicForm>, IDynamicFormQueryRepository
    {
        ...
        public async Task<IReadOnlyList<DynamicForm>> GetAllAsync(long? userId)
        {
            ...
            try
            {
                ...
                var query = "select t1.IsAuditTrail,t1.VersionNo,t1.SopNo,t1.ID,\r\nt1.Name,\r\nt1.ScreenID,\r\nt1.SessionID,\r\nt1.AttributeID,\r\nt1.StatusCodeID,\r\nt1.AddedByUserID,\r\nt1.AddedDate,\r\nt1.ModifiedByUserID,\r\nt1.ModifiedDate,\r\nt1.IsApproval,\r\nt1.IsUpload,\r\nt1.FileProfileTypeID,\r\nt1.IsProfileNoGenerate,\r\nt1.IsMultipleUpload,\r\nt1.CompanyID,\r\nt1.ProfileID,\r\nt1.IsGridForm,\r\nt1.IsDeleted,\n\r" +
...
";
        ...
        public async Task<DynamicFormData> InsertOrUpdateDynamicFormData(DynamicFormData dynamicFormData)
        {
            try
            {
                ...
                var preGridData = await GetDynamicFormDataOneByIdAsync(dynamicFormData.DynamicFormDataGridId > 0 ? dynamicFormData.DynamicFormDataGridId : 0);
                using (var connection = CreateConnection())
                {
                    try
                    {
                        ...
                        if (preData != null)
                        {
                            await InsertAuditTrail(dynamicFormData, preData, dynamicFormData.ModifiedDate, preGridData);
                        }
                        else
                        {
                            await InsertAuditTrail(dynamicFormData, preData, dynamicFormData.ModifiedDate, preGridData);
        ...
        private async Task<DynamicFormData> InsertAuditTrail(DynamicFormData CurrentData, DynamicFormData PrevData, DateTime? ModifiedDate, DynamicFormData dynamicFormGridData)
        {
            try
            {
                using (var connection = CreateConnection())
                {
                    try
                    {
                        if (CurrentData.AuditParentSessionId != null)
                        {
                            ...
                            if (CurrentDatajsonObj != null)
                            {
                                ...
                                foreach (var item in CurrentDatajsonObj)
                                {
                                    ...
                                    if (itemValue != PreValueSet)
                                    {
                                        ...
                                        parameters.Add("AuditDateTime", ModifiedDate, DbType.DateTime);
        ...
        private async Task<DynamicFormData> InsertSubFormAuditTrail(DynamicFormData CurrentData, DynamicFormData PrevData, DateTime? ModifiedDate, DynamicFormData dynamicFormGridData)
        {
            try
            {
                using (var connection = CreateConnection())
                {
                    ...
                    {
                        var parameters1 = new DynamicParameters();
                        parameters1.Add("SessionID", CurrentData.AuditParentSessionId);
                        parameters1.Add("DynamicFormSectionAttributeId", CurrentData.DynamicFormSectionAttributeId);
                        var query1 = "select * from DynamicFormDataAudit where DynamicFormSectionAttributeId=@DynamicFormSectionAttributeId AND SessionID=@SessionID;";
                        var result = await connection.QueryFirstOrDefaultAsync<DynamicFormDataAudit>(query1, parameters1);
                        if (result == null)
                        {
                            var query = string.Empty;
                            var parameters = new DynamicParameters();
                            parameters.Add("DynamicFormDataId", CurrentData.DynamicFormDataGridId);
                            parameters.Add("AuditUserId", CurrentData.ModifiedByUserID);
                            parameters.Add("AuditDateTime", ModifiedDate, DbType.DateTime);
                            parameters.Add("PreUserID", dynamicFormGridData?.ModifiedByUserID);
                            parameters.Add("PreUpdateDate", dynamicFormGridData?.ModifiedDate, DbType.DateTime);
                            parameters.Add("PrevData", null, DbType.String);
                            parameters.Add("CurrentData", null, DbType.String);
                            parameters.Add("SessionId", CurrentData.AuditParentSessionId, DbType.Guid);
                            parameters.Add("CurrentValueId", null, DbType.String);
                            parameters.Add("PrevValueId", null, DbType.String);
                            parameters.Add("AuditParentSessionId", null, DbType.Guid);
                            parameters.Add("DynamicFormSectionAttributeId", CurrentData.DynamicFormSectionAttributeId);
                            parameters.Add("AttributeId", CurrentData.DynamicAttributeName, DbType.String);
                            query += "INSERT INTO DynamicFormDataAudit(AttributeId,DynamicFormSectionAttributeId,CurrentData,PrevData,AuditParentSessionId,DynamicFormDataId,AuditUserId,AuditDateTime,PreUserID,PreUpdateDate,SessionId,CurrentValueId,PrevValueId)  OUTPUT INSERTED.DynamicFormDataAuditId VALUES " +
                        "(@AttributeId,@DynamicFormSectionAttributeId,@CurrentData,@PrevData,@AuditParentSessionId,@DynamicFormDataId,@AuditUserId,@AuditDateTime,@PreUserID,@PreUpdateDate,@SessionId,@CurrentValueId,@PrevValueId);\n\r";
                        ...
                        parameters2.Add("DynamicFormDataId", CurrentData.DynamicFormDataGridId);
                        parameters2.Add("ModifiedByUserID", CurrentData.ModifiedByUserID);
                        parameters2.Add("ModifiedDate", ModifiedDate, DbType.DateTime);
                        var query3 = "Update DynamicFormData SET  ModifiedDate=@ModifiedDate,ModifiedByUserID=@ModifiedByUserID where DynamicFormDataId=@DynamicFormDataId;";
        ...
        public async Task<DynamicFormData> DeleteDynamicFormData(DynamicFormData dynamicFormData, long? UserId)
        {
            try
            {
                using var connection = CreateConnection();
                ...
                var parameters = new DynamicParameters();
                parameters.Add("DynamicFormDataId", dynamicFormData.DynamicFormDataId);
                parameters.Add("AuditUserId", UserId);
                parameters.Add("PrevData", dynamicFormData.DynamicFormItem, DbType.String);
                parameters.Add("AuditDateTime", DateTime.Now, DbType.DateTime);
                parameters.Add("SessionId", Guid.NewGuid(), DbType.Guid);
                parameters.Add("IsRecordDeleted", true, DbType.String);
                parameters.Add("AuditParentSessionId", dynamicFormData.AuditParentSessionId, DbType.Guid);

                query += "INSERT INTO DynamicFormDataAudit(PrevData,AuditParentSessionId,DynamicFormDataId,AuditUserId,AuditDateTime,IsRecordDeleted,SessionId)  OUTPUT INSERTED.DynamicFormDataAuditId VALUES " +
            "(@PrevData,@AuditParentSessionId,@DynamicFormDataId,@AuditUserId,@AuditDateTime,@IsRecordDeleted,@SessionId);\n\r";
        ...
        public async Task<IReadOnlyList<DynamicFormPermission>> GetDynamicFormPermissionEmptyAsync(long? dynamicFormId)
        {
            try
            {
                var parameters = new DynamicParameters();
                parameters.Add("dynamicFormId", dynamicFormId);
                var query = "select  * from DynamicFormPermission where  DynamicFormId=@dynamicFormId";

                using (var connection = CreateConnection())
                {
                    return (await connection.QueryAsync<DynamicFormPermission>(query, parameters)).ToList();
                }
            }
            catch (Exception exp)
            {
        ...
        public async Task<DynamicFormPermission> GetDynamicFormPermissionCheckAsync(long? dynamicFormId, long? UserId)
        {
            try
            {
                DynamicFormPermission result = new DynamicFormPermission();
                var emptyCheck = await GetDynamicFormPermissionEmptyAsync(dynamicFormId);
                var empC = emptyCheck.ToList();
                if (empC?.Any() == true)
                {
                    var parameters = new DynamicParameters();
                    parameters.Add("dynamicFormId", dynamicFormId);
                    parameters.Add("UserId", UserId);
                    var query = "select  * from DynamicFormPermission where  UserId=@UserId AND DynamicFormId=@dynamicFormId";

                    using (var connection = CreateConnection())
                    {
                        var result1 = connection.QueryFirstOrDefault<DynamicFormPermission>(query, parameters);
                        if (result1 != null)
                        {
                            result.IsAdd = result1.IsAdd;
                            result.IsEdit = result1.IsEdit; result.IsDelete = result1.IsDelete;
                        }
                    }
                }
                else
                {
                    ...
                    result.IsAdd = true;
                    result.IsEdit = true; result.IsDelete = true;
                }
                return result;
            }
            catch (Exception exp)
        ...
        public async Task<DynamicFormPermission> InsertDynamicFormPermission(DynamicFormPermission value)
        {
            try
            {
                using (var connection = CreateConnection())
                {
                    var userExitsRoles = await GetDynamicFormPermissionEmptyAsync(value.DynamicFormId);
                    var userGroupUsers = await GetUserGroupUserList();
                    var LevelUsers = await GetLeveMasterUsersList(value.SelectLevelMasterIDs);
                                ...
                                foreach (var item in value.SelectUserIDs)
                                {
                                    if (item > 0)
                                    {
                                        ...
                                        if (counts == null)
                                        {
                                            ...
                                            parameters1 = parameters;
                                            parameters1.Add("UserId", item);
                                            var query1 = "INSERT INTO [DynamicFormPermission](Type,IsDelete,IsEdit,IsAdd,DynamicFormId,UserId) OUTPUT INSERTED.DynamicFormPermissionId " +
                                                "VALUES (@Type,@IsDelete,@IsEdit,@IsAdd,@DynamicFormId,@UserId);\r\n";
                                            var ids = await connection.QuerySingleOrDefaultAsync<long>(query1, parameters1);
                                            var UniqueSessionId = Guid.NewGuid();
                                            await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, value.IsEdit.ToString(), value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "IsEditPermission", UniqueSessionId);
                                            await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, value.IsAdd.ToString(), value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "IsAddPermission", UniqueSessionId);
                                            await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, value.IsDelete.ToString(), value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "IsDeletePermission", UniqueSessionId);
                                            ...
                                            //await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, value.DynamicFormId > 0 ? value.DynamicFormId.ToString() : null, value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "DynamicFormId", UniqueSessionId, value.DynamicFormId);
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts.IsEdit.ToString(), value.IsEdit.ToString(), value.DynamicFormId, counts.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "IsEditPermission", UniqueSessionId);
                                                isUpdate = true;
                                            }
                                            if (counts.IsAdd != value.IsAdd)
                                            {
                                                await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts.IsAdd.ToString(), value.IsAdd.ToString(), value.DynamicFormId, counts.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "IsAddPermission", UniqueSessionId);

                                                isUpdate = true;
                                            }
                                            if (counts.IsDelete != value.IsDelete)
                                            {
                                                await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts.IsDelete.ToString(), value.IsDelete.ToString(), value.DynamicFormId, counts.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "IsDeletePermission", UniqueSessionId);
                                            ...
                                            if (isUpdate)
                                            {
                                                ...
                                                await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts != null && counts.Type != null ? counts?.Type.ToString() : null, value.Type != null ? value.Type.ToString() : null, value.DynamicFormId, counts.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "Type", UniqueSessionId);
                                                await InsertDynamicFormAudit("Update", "DynamicFormPermission", preValueData, item.ToString(), value.DynamicFormId, counts.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "UserId", UniqueSessionId);
                                                // await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts.DynamicFormId > 0 ? counts.DynamicFormId.ToString() : null, value.DynamicFormId.ToString(), value.DynamicFormId, counts.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "DynamicFormId", UniqueSessionId);
                                            ...
                                            parameters1.Add("UserGroupId", null);
                                            parameters1.Add("LevelId", null);
                                            var query1 = " UPDATE DynamicFormPermission SET UserId=@UserId,UserGroupId=@UserGroupId,LevelId=@LevelId,Type=@Type,IsDelete=@IsDelete,IsEdit=@IsEdit,IsAdd=@IsAdd WHERE DynamicFormPermissionId='" + counts.DynamicFormPermissionId + "' AND DynamicFormId = @DynamicFormId;\r\n";
                                            await connection.QuerySingleOrDefaultAsync<long>(query1, parameters1);
                                        }
                                    }
                                }
                                    ...
                                    foreach (var s in userGropuIds)
                                    {
                                        if (s.UserGroupId > 0 && s.UserId > 0)
                                        {
                                            ...
                                            if (counts == null)
                                            {
                                                ...
                                                parameters1.Add("UserId", s.UserId);
                                                parameters1.Add("UserGroupId", s.UserGroupId);
                                                var query1 = "INSERT INTO [DynamicFormPermission](Type,IsDelete,IsEdit,IsAdd,DynamicFormId,UserId,UserGroupId) OUTPUT INSERTED.DynamicFormPermissionId " +
                                                ...
                                                await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, s.UserId > 0 ? s.UserId.ToString() : null, value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "UserId", UniqueSessionId);
                                                //await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, value.DynamicFormId > 0 ? value.DynamicFormId.ToString() : null, value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "DynamicFormId", UniqueSessionId);
                                            ...
                                            else
                                            {
                                                ...
                                                if (isUpdate)
                                                {
                                                    ...
                                                    await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts?.Type != null ? counts?.Type.ToString() : null, value.Type != null ? value.Type.ToString() : null, value.DynamicFormId, counts?.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "Type", UniqueSessionId);
                                                    await InsertDynamicFormAudit("Update", "DynamicFormPermission", preValueData, s.UserGroupId > 0 ? s.UserGroupId.ToString() : null, value.DynamicFormId, counts?.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "UserId", UniqueSessionId);
                                                    //await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts?.DynamicFormId > 0 ? counts.DynamicFormId.ToString() : null, value.DynamicFormId > 0 ? value.DynamicFormId.ToString() : null, value.DynamicFormId, counts?.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "DynamicFormId", UniqueSessionId, value.DynamicFormId);
                                ...
                                foreach (var s in LevelUsers)
                                {
                                    if (s.LevelId > 0 && s.UserId > 0)
                                    {
                                        ...
                                        if (counts == null)
                                        {
                                            ...
                                            parameters1.Add("UserId", s.UserId);
                                            parameters1.Add("LevelId", s.LevelId);
                                            var query1 = "INSERT INTO [DynamicFormPermission](Type,IsDelete,IsEdit,IsAdd,DynamicFormId,UserId,LevelId) OUTPUT INSERTED.DynamicFormPermissionId " +
                                            ...
                                            await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, s.UserId.ToString(), value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "UserId", UniqueSessionId);
                                            // await InsertDynamicFormAudit("Add", "DynamicFormPermission", string.Empty, value.DynamicFormId > 0 ? value.DynamicFormId.ToString() : null, value.DynamicFormId, ids, sesId, UserId, DateTime.Now, false, "DynamicFormId", UniqueSessionId);
                                        ...
                                        else
                                        {
                                            ...
                                            if (isUpdate)
                                            {
                                                ...
                                                await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts?.Type != null ? counts?.Type.ToString() : null, value.Type != null ? value.Type.ToString() : null, value.DynamicFormId, counts?.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "Type", UniqueSessionId);
                                                await InsertDynamicFormAudit("Update", "DynamicFormPermission", preValueData, s.LevelId > 0 ? s.LevelId.ToString() : null, value.DynamicFormId, counts?.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "UserId", UniqueSessionId);
                                                // await InsertDynamicFormAudit("Update", "DynamicFormPermission", counts?.DynamicFormId > 0 ? counts.DynamicFormId.ToString() : null, value.DynamicFormId.ToString(), value.DynamicFormId, counts?.DynamicFormPermissionId, sesId, UserId, DateTime.Now, false, "DynamicFormId", UniqueSessionId);
        ...
        public async Task<IReadOnlyList<DynamicFormPermission>> GetDynamicFormPermissionList(long? Id)
        {
            try
            {
                var parameters = new DynamicParameters();
                parameters.Add("DynamicFormId", Id);
                var query = "select t1.DynamicFormPermissionID,\r\n\r\nt1.UserID,\r\nt1.UserGroupID,\r\nt1.LevelID,\r\nt1.IsAdd,\r\nt1.IsEdit,\r\nt1.IsDelete,\r\nt3.Name as UserGroup,\r\nt3.Description as UserGroupDescription,\r\n" +
                    "t5.Name as LevelName,\r\nt6.NickName,\r\nt6.FirstName,\r\nt6.LastName,\r\nt7.Name as DepartmentName,\r\n" +
                    "t8.Name as DesignationName,\r\n" +
                    "CONCAT(case when t6.NickName is NULL OR  t6.NickName='' then  ''\r\n ELSE  CONCAT(t6.NickName,' | ') END,t6.FirstName, (case when t6.LastName is Null OR t6.LastName='' then '' ELSE '-' END),t6.LastName) as FullName\r\n" +
                    "from DynamicFormPermission t1\r\n" +
                    "LEFT JOIN UserGroup t3 ON t1.UserGroupID=t3.UserGroupID\r\n" +
                    "LEFT JOIN LevelMaster t5 ON t1.LevelID=t5.LevelID\r\n" +
                    "JOIN Employee t6 ON t1.UserID=t6.UserID\r\n" +
                    "LEFT JOIN Department t7 ON t6.DepartmentID=t7.DepartmentID\r\n" +
        ...
        public async Task GetDynamicFormPermissionListOne(string? IdList, long? UserId, DynamicFormSection res)
        {
            try
            {
                List<DynamicFormPermission> dynamicFormSectionSecurities = new List<DynamicFormPermission>();
                var parameters = new DynamicParameters();
                var query = "select * from DynamicFormPermission where DynamicFormPermissionId in (" + IdList + ");\r\n";
                using (var connection = CreateConnection())
                {
                    dynamicFormSectionSecurities = (await connection.QueryAsync<DynamicFormPermission>(query, parameters)).ToList();
                }
                if (dynamicFormSectionSecurities != null && dynamicFormSectionSecurities.Count() > 0)
                {
                    var sesId = Guid.NewGuid();
        ...
        public async Task<DynamicFormSection> GetDynamicFormDynamicFormPermissionOne(long? DynamicFormId)
        {
            try
            {
                var parameters = new DynamicParameters();
                parameters.Add("DynamicFormId", DynamicFormId);
                var query = "select * from DynamicFormSection where DynamicFormId=@DynamicFormId;";
                using (var connection = CreateConnection())
                {
                    return await connection.QueryFirstOrDefaultAsync<DynamicFormSection>(query, parameters);
                }
        ...
        public async Task<long> DeleteDynamicFormPermission(long? Id, List<long?> Ids, long? UserId)
        {
            try
            {
                using (var connection = CreateConnection())
                {
                    ...
                    try
                    {
                        var query = string.Empty;
                        var parameters = new DynamicParameters();
                        parameters.Add("IsAdd", false);
                        parameters.Add("IsEdit", false);
                        parameters.Add("IsDelete", false);
                        parameters.Add("DynamicFormId", Id);
                        var res = await GetDynamicFormDynamicFormPermissionOne(Id);

                        if (Ids != null && Ids.Count > 0)
                        {

                            string IdList = string.Join(",", Ids);
                            query += "Delete From DynamicFormPermission WHERE DynamicFormPermissionId in (" + IdList + ");\r\n";
                            await GetDynamicFormPermissionListOne(IdList, UserId, res);
                        }
                        if (!string.IsNullOrEmpty(query))
                        {
                        ...
                        await DeleteCheckDynamicFormPermission(Id);
                        return Id.GetValueOrDefault(0);
                    }
                    catch (Exception exp)
                    {
        ...
        public async Task<long> DeleteCheckDynamicFormPermission(long? Id)
        {
            try
            {
                using (var connections = CreateConnection())
                {
                    ...
                    try
                    {
                        var userExitsRoles = await GetDynamicFormPermissionEmptyAsync(Id);
                        if (userExitsRoles == null || userExitsRoles.Count == 0)
                        {
                            var query = string.Empty;
                            var parameters = new DynamicParameters();
                            ...
                            parameters.Add("IsDelete", false);
                            parameters.Add("DynamicFormId", Id);
                            query += " UPDATE DynamicFormPermission SET IsDelete=@IsDelete,IsEdit=@IsEdit,IsAdd=@IsAdd WHERE DynamicFormId = @DynamicFormId;\r\n";
                            if (!string.IsNullOrEmpty(query))
                            {
                                await connections.QuerySingleOrDefaultAsync<long>(query, parameters);
                            }
        ...
        public async Task<IReadOnlyList<DynamicFormPermission>> GeDynamicFormPermissionListIds(List<long?> Ids)
        {
            try
            {
                DynamicFormWorkFlow listOneData = new DynamicFormWorkFlow();
                var parameters = new DynamicParameters();
                var query = string.Empty;
                parameters.Add("@DynamicFormPermissionId", Ids);

                query += "SELECT * from  DynamicFormPermission where DynamicFormPermissionId IN @DynamicFormPermissionId;";


                using (var connection = CreateConnection())
                {
                    var QuerResult = await connection.QueryMultipleAsync(query, parameters);
                    return QuerResult.Read<DynamicFormPermission>().ToList();
...
";
        ...
        public async Task<IReadOnlyList<DynamicFormDataAudit>> GetDynamicFormDataAuditList(Guid? SessionId, bool IsGridAudit, DynamicFormDataAudit DynamicFormDataAuditGridData)
        {
            try
            {
                ...
                var parameters = new DynamicParameters();
                parameters.Add("SessionId", SessionId, DbType.Guid);
                parameters.Add("DynamicFormSectionAttributeId", DynamicFormDataAuditGridData?.DynamicFormSectionAttributeId);
                parameters.Add("DynamicFormGridDropDownId", DynamicFormDataAuditGridData?.DynamicFormGridDropDownId);
        ...
        public async Task<IReadOnlyList<DynamicFormDataAudit>> GetDynamicFormDataAuditMasterList(DynamicFormDataAudit dynamicFormDataAudit)
        {
            try
            {
                ...
                if (dynamicFormDataAudit.AuditUserId != null)
                {
                    auditFilter = " AND t1.AuditUserID = @AuditUserId";
                    parameters.Add("AuditUserId", dynamicFormDataAudit.AuditUserId);
                }
                ...
                if (dynamicFormDataAudit.AuditDateTime != null)
                {
                    // Use a date (or start of day) and compare with a range
                    var date = dynamicFormDataAudit.AuditDateTime.Value.Date;
                    parameters.Add("AuditDate", date, DbType.Date);

                    dateFilter = @" AND t1.AuditDateTime >= @AuditDate AND t1.AuditDateTime < DATEADD(DAY, 1, @AuditDate)";
                }

                // DynamicFormDataGridID filter
                if (dynamicFormDataAudit.DynamicFormDataGridID > 0)
                {
                    subFilter = " AND d.DynamicFormDataGridID = @DynamicFormDataGridID";
                    parameters.Add("DynamicFormDataGridID", dynamicFormDataAudit.DynamicFormDataGridID);
                }

                // IsDeleted filter on DynamicFormData
                if (dynamicFormDataAudit.IsDeleted == true)
                {
                    isDeletedFilter = " AND d.IsDeleted = 1";
                }
                else
                {
                    //isDeletedFilter = " AND (d.IsDeleted IS NULL OR d.IsDeleted = 0)";
                }
                var query = $@";WITH AuditCTE AS(SELECT t1.PrevData,t1.IsRecordDeleted,t1.DynamicFormDataID,t1.AuditUserID,t1.SessionID,t1.DynamicFormDataAuditID,t1.AuditDateTime,t1.PreUpdateDate,t1.PreUserID,ROW_NUMBER() OVER (PARTITION BY t1.DynamicFormDataID, t1.AuditUserID, t1.SessionID ORDER BY t1.DynamicFormDataAuditID ASC) AS rn,COUNT(*) OVER(PARTITION BY t1.DynamicFormDataID, t1.AuditUserID, t1.SessionID) AS CountData FROM DynamicFormDataAudit t1 WHERE 1 = 1    {auditFilter}    {dateFilter}),ttt2 AS(SELECT a.PrevData,a.IsRecordDeleted,a.DynamicFormDataID,a.AuditUserID,a.SessionID,a.DynamicFormDataAuditID,a.AuditDateTime,a.PreUpdateDate,a.PreUserID,a.CountData,d.IsDeleted,d.ProfileNo,d.SessionID AS DynamicFormDataSessionID,f.SessionID AS DynamicFormSessionID,d.DynamicFormID,f.Name AS DynmaicForm,au.UserName AS AuditUser FROM AuditCTE a JOIN DynamicFormData d  ON d.DynamicFormDataID = a.DynamicFormDataID       {subFilter}       {isDeletedFilter}    JOIN DynamicForm f  ON f.ID = d.DynamicFormID  AND (f.IsDeleted IS NULL OR f.IsDeleted = 0) AND f.ID = @DynamicFormId JOIN ApplicationUser au ON au.UserID = a.AuditUserId  WHERE a.rn = 1)SELECT ROW_NUMBER() OVER (ORDER BY tt3.DynamicFormDataAuditId DESC) AS RowNum,ttt2.*,tt6.UserName AS PreUser,tt3.AuditDateTime,tt3.PreUpdateDate FROM ttt2 JOIN DynamicFormDataAudit tt3  ON tt3.DynamicFormDataAuditID = ttt2.DynamicFormDataAuditID LEFT JOIN ApplicationUser tt6  ON tt6.UserID = tt3.PreUserID ORDER BY tt3.AuditDateTime DESC;";
                using (var connection = CreateConnection())
                {
                    dynamicFormDataAudits = (await connection.QueryAsync<DynamicFormDataAudit>(query, parameters)).ToList();
                }
        ...
        public async Task<IReadOnlyList<DynamicFormDataAudit>> GetDynamicFormDataAuditBySessionList(Guid? SessionId)
        {
            try
            {
                ...
                var parameters = new DynamicParameters();
                parameters.Add("SessionId", SessionId, DbType.Guid);
                var query = "select t2.IsDeleted,Row_Number() Over (Order By t1.DynamicFormDataAuditId desc) As RowNum,t1.*,t2.DisplayName,t3.UserName as AuditUser,t4.UserName as PreUser from DynamicFormDataAudit t1 LEFT JOIN DynamicFormSectionAttribute t2 ON t1.DynamicFormSectionAttributeID=t2.DynamicFormSectionAttributeID\r\nJOIN ApplicationUser t3 ON t3.UserID=t1.AuditUserID LEFT JOIN ApplicationUser t4 ON t4.UserID=t1.PreUserID where t1.SessionId=@SessionId";
        ...
        public async Task<IReadOnlyList<DynamicFormDataAudit>> GetDynamicFormDataAuditBySessionMultipleList(List<Guid?> SessionId)
        {
            try
            {
                List<DynamicFormDataAudit> dynamicFormDataAudits = new List<DynamicFormDataAudit>(); List<DynamicFormDataAudit> dynamicSubFormDataAudits = new List<DynamicFormDataAudit>();
                var parameters = new DynamicParameters();
                if (SessionId != null && SessionId.Count > 0)
                {
                    string? SessionIds = string.Join(',', SessionId.Select(i => $"'{i}'"));
                    ...
                    {
                        var results = await connection.QueryMultipleAsync(query, parameters);
                        dynamicFormDataAudits = results.Read<DynamicFormDataAudit>().ToList();
                        dynamicSubFormDataAudits = results.Read<DynamicFormDataAudit>().ToList();
                    }
                    if (dynamicFormDataAudits?.Any() == true)
                    {
                        dynamicFormDataAudits.ForEach(s =>
                        {
                            if (s.ControlTypeId == 2712)
                            {
                                s.DynamicFormDataAudits = dynamicSubFormDataAudits.Where(w => w.AuditParentSessionId == s.SessionId && w.DynamicFormGridDropDownId == s.DynamicFormGridDropDownId).ToList();
                            }
                        });
                    }
                }
