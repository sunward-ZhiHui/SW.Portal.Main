            ...
            if (request != null)
            {
                try
                {
                    ...
                    foreach (var job in request.RegistrationRequestAssignmentOfJobs)
                    {
                        ...
                        {
                            SubemailContents = "<html><head><style>#RegTableFormID {font-family: arial, sans-serif; border-collapse: collapse;width: 100%;} #RegTableFormID td, th { border: 1px solid #dddddd;text-align: left;padding: 8px;}</style></head><body><table id=\"RegTableFormID\">";
                        ...
                        var emailConversation = new EmailConversations
                        {
                            ...
                            FileData = Encoding.UTF8.GetBytes(SubemailContents + "<br/><div>" + request.MessageContent + "</div>"),
                            IsAllowParticipants = true,
                            Urgent = false,
                            Follow = "No Follow Up",
                            ReplyId = 0,
                            ParticipantId = request.FromId.Value,
                            Message = SubemailContents + "<br/><div>" + request.MessageContent + "</div>",
                            UserType = "Users",
                            DueDate = null,
