...
namespace Infrastructure.Repository.Query
{
    ...
    public class RoutineAppLineQueryRepository : QueryRepository<ProductionActivityRoutineAppLine>, IRoutineLineAppQuery
    {
        public RoutineAppLineQueryRepository(IConfiguration configuration)
            : base(configuration)
        {

        }

        public async Task<IReadOnlyList<ProductionActivityRoutineAppLine>> GetAllAsync(long? CompanyId)
        {
            try
            {
                ...
                {
                    return (await connection.QueryAsync<ProductionActivityRoutineAppLine>(query, parameters)).ToList();
                }
            }
            catch (Exception exp)
            {
        ...
        public async Task<IReadOnlyList<ProductionActivityRoutineAppLine>> GetAllAsyncPO(long? CompanyId)
        {
            try
            {
                var parameters = new DynamicParameters();
