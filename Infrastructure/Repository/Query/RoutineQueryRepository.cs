        ...
        public async Task<IReadOnlyList<ProductionActivityRoutineAppModel>> GetAllProductionActivityRoutineAsync(ProductionActivityRoutineAppModel value)
        {
            ...
            try
            {
                ...
                if(value.TimeSheetAction == true)
                {
                    ...
                    ,t2.CompanyID,t10.PlantCode as CompanyName,PAC.FileProfileTypeID AS MasterProductionFileProfileTypeId,t2.ProdOrderNo,t2.Comment,t2.SessionId,t2.LocationID,t14.Description as LocationName,t2.BatchNo,
                    ...
                    LEFT JOIN ProductActivityCase PAC ON PAC.ProductActivityCaseID = t1.ProductActivityCaseID
