        ...
        public async Task<IReadOnlyList<SyrupOtherProcess>> GetSyrupOtherProcessList()
        {
            try
            {
                ...
                var query = @"SELECT 
                            ...
                            DynamicFormDataID,
                            '' AS OtherJobsInformation,
                            '' AS ProcessName,
                            ProfileNo,
                            '' AS SyrupOtherProcessNextProcess,
                            '' AS MustCompleteForNext,
                            '' AS LocationOfProcess,
                            0.0 AS ManhoursOrHours,
                            0 AS NoOfManpower,
                            '' AS ManpowerFromNextProcess,
                            '' AS CanCarryoutOnNonWorkday,
                            0.0 AS TimeGapHour,
                            0 AS AddedByUserID,
                            '' AS Description,
                            '' AS ModifiedBy,
