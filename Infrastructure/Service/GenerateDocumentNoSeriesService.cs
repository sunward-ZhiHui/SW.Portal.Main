    ...
    public class GenerateDocumentNoSeriesService : QueryRepository<DocumentNoSeriesModel>, IGenerateDocumentNoSeriesSeviceQueryRepository
    {
        ...
        private string GenerateProfileAuto(DocumentNoSeriesModel noSeriesModel, ProfileAutoNumber profileAutonumber, DocumentProfileNoSeries profilesettings, string documentNo)
        {
            ...
            if (profileAutonumber == null)
            {
                ...
                _generateDocumentNoSeriesQueryRepository.InsertProfileAutoNumber(newProfileAutoNumber);
                    ...
                    if (noSeriesModel != null)
                    {
                        if (noSeriesModel.PlantID != null && noSeriesModel.DepartmentId != null && noSeriesModel.SectionId != null && noSeriesModel.SubSectionId != null)
                        {
                            ...
                            if (existingprofileAutonumber != null)
                            {
                                ...
                                _generateDocumentNoSeriesQueryRepository.UpdateDocumentProfileNoSeriesLastNoUsed(existingprofileAutonumber);
                            }
                        }
                        if (noSeriesModel.PlantID == null && noSeriesModel.DepartmentId != null && noSeriesModel.SectionId != null && noSeriesModel.SubSectionId != null)
                        {
            ...
            else
            {
                ...
                documentNo += LastNoUsed;
                _generateDocumentNoSeriesQueryRepository.UpdateDocumentProfileNoSeriesLastNoUsed(profileAutonumber);
            }
            return documentNo;
        }
    }
