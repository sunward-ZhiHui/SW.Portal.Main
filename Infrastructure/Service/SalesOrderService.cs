...
namespace Infrastructure.Service
{
    public class SalesOrderService : QueryRepository<PostSalesOrder>, ISalesOrderService
    {
        ...
        public async Task<List<Core.Entities.ReleaseProdOrderLine>> ReleaseProdOrderLineAsync(string company, long companyid, List<Core.Entities.ReleaseProdOrderLine> releaseProdOrderLines, List<Navitems> navitems)
        {
            try
            {
                List<Core.Entities.ReleaseProdOrderLine> releaseProdOrderLinesList = new List<Core.Entities.ReleaseProdOrderLine>();
                int pageSize = 1000;
                int page = 0;
                while (true)
                {
